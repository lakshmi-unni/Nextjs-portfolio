...
//         whileInView={{ opacity: 1 }}
//         transition={{ duration: 0.9, delay: 0.6 }}
//         className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 my-10 dark:text-black"
//       >
//         {workData.map((project, index) => (
//           <motion.div
//             key={index}
...
//             {/* Project Details */}
//             <div className="bg-white absolute bottom-5 left-1/2 transform -translate-x-1/2 py-3 px-5 flex flex-col items-center justify-center text-center rounded-md shadow-lg w-11/12 sm:w-9/12 md:w-4/5 max-w-lg">
//               <h2 className="font-semibold">{project.title}</h2>
...
//         >
//           <div className="bg-white p-6 rounded-lg w-11/12 sm:w-4/5 max-w-3xl relative">
//             {/* Close Button */}
//             <button
...
const Work = ({ isDarkMode }) => {
  ...
  const importantProjects = workData.slice(0, 4);
  const remainingProjects = workData.slice(4);
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 my-10 dark:text-black"
      >
        {(showAll ? workData : importantProjects).map((project, index) => (
          <motion.div
            key={index}
            whileHover={{ scale: 1.05 }}
            transition={{ duration: 0.3 }}
          ...
          >
            ...
            <div className="bg-white absolute bottom-5 left-1/2 transform -translate-x-1/2 py-3 px-5 flex flex-col items-center justify-center text-center rounded-md shadow-lg w-11/12 sm:w-9/12 md:w-4/5 max-w-lg">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="absolute right-7 lg:right-3 top-9 lg:top-10 group"
              >
                <div className="border rounded-full border-black w-7 h-7 flex items-center justify-center shadow-[2px_2px_0_#000] group-hover:bg-lime-300">
                  <Image
                    src={assets.send_icon}
